...
describe('Placeholder Testing - Modern Browsers', function () {
    ...
    beforeEach(inject(function ($compile, $rootScope, $timeout) {
        ...
        elem = $compile('<input id="weight" name="weight" type="number" default-text="lbs" min="50" max="500" required />')(rootScope);
...
describe('Placeholder Testing - IE Test', function () {
    ...
    beforeEach(inject(function ($compile, $rootScope, $timeout) {
        ...
        var elm = angular.element('<input id="weight" name="weight" type="number" default-text="1111" min="50" max="500" required />');
        // Compile a piece of HTML containing the directive
...
describe('Placeholder Testing - IE Test', function () {
    ...
    beforeEach(inject(function ($compile, $rootScope) {
        ...
        rootScope = $rootScope;
        // html5 numeric field does not allow characters so a modified had to be made to allow testing with phamtomjs
        var elm = angular.element('<input id="password" name="password" type="password" default-text="1111" min="50" max="500" required />');
        // Compile a piece of HTML containing the directive
        elem = $compile(elm)(rootScope);
    }));
